    ...
    <div className='max-w-3xl text-black'>
      <ReactMarkdown
        components={{
          ...
          blockquote: ({ children }) => <blockquote className='my-10 border-s-4 border-black ps-6 text-xl font-medium leading-8 tracking-[-0.02em] text-black/75'>{children}</blockquote>,
          code: ({ children, className }) => className ? <code className={`${className} block overflow-x-auto bg-neutral-950 p-5 text-sm leading-7 text-white`} dir='ltr'>{children}</code> : <code className='bg-neutral-100 px-1.5 py-1 text-[0.92em]' dir='ltr'>{children}</code>,
          ...
          ol: ({ children }) => <ol className='my-6 list-decimal space-y-3 ps-6 text-base leading-8 text-black/65 sm:text-lg'>{children}</ol>,
          p: ({ children }) => <p className='my-6 text-base leading-8 text-black/65 sm:text-lg sm:leading-9'>{children}</p>,
          pre: ({ children }) => <pre className='my-8 overflow-hidden' dir='ltr'>{children}</pre>,
          table: ({ children }) => <div className='my-8 overflow-x-auto'><table className='w-full border-collapse text-start text-sm'>{children}</table></div>,
          ...
          ul: ({ children }) => <ul className='my-6 list-disc space-y-3 ps-6 text-base leading-8 text-black/65 sm:text-lg'>{children}</ul>,
        }}
