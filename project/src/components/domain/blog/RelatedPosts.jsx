  ...
  return (
    <section className='bg-neutral-50 py-20 sm:py-24'>
      <div className='mx-auto w-full max-w-[1600px] px-4 sm:px-6 lg:px-[clamp(2.5rem,4vw,4.75rem)]'>
        <p className='text-xs font-semibold uppercase tracking-[0.16em] text-black/40'>{t('common.labels.continueReading')}</p>
        <h2 className='mt-5 text-4xl font-semibold tracking-[-0.05em] sm:text-5xl'>{t('common.labels.relatedArticles')}</h2>
