...
function BookNowStrip() {
  ...
  const copy = content.pages.home.bookNow
  const href = localizePath('/book')

  return (
    <section aria-labelledby='book-now-title' className='bg-white py-12 sm:py-16 lg:py-20'>
