    ...
    <article className='border-t border-black/15 last:border-b'>
      <h3>
        <button
          ...
          className='group flex w-full items-center justify-between gap-6 py-6 text-left outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-4'
          onClick={onToggle}
          type='button'
        >
          <span className='text-lg font-medium tracking-[-0.02em] text-black sm:text-xl'>
            {question}
          </span>
      ...
      >
        <div className='overflow-hidden'>
          <p className='max-w-2xl pb-7 pr-12 text-base leading-7 text-black/55'>
            {answer}
          </p>
        </div>
      </div>
