  ...
  return (
    <SiteLayout>
      <main aria-label={`${project.title} project page`} id='main-content'>
        ...
        <div className='aspect-[16/8] w-full overflow-hidden bg-white'><img alt={`${project.title} cover`} height='900' className='size-full object-contain p-4 sm:p-8' width='1200' src={project.coverImage} /></div>
        ...
        <section className='bg-black py-20 text-white sm:py-24'><div className='mx-auto w-full max-w-[1600px] px-4 sm:px-6 lg:px-[clamp(2.5rem,4vw,4.75rem)]'><MediaGrid fit='contain' images={project.gallery} title={`${project.title} gallery`} /></div></section>
