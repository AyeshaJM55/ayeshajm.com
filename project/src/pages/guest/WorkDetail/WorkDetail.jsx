  ...
  return (
    <SiteLayout>
      <main aria-label={`${project.title} project page`} id='main-content'>
        ...
        <div className='aspect-[16/8] w-full overflow-hidden bg-neutral-100'><img alt={`${project.title} cover`} height='900' className='size-full object-contain p-4 sm:p-8' width='1200' src={project.coverImage} /></div>
